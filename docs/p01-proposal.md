...
I realized that these first two questions are more than a little bit vague, so I'm gonna add some pointers here for you guys.

1. By COVID restrictions I meant lockdowns, air-land travel restrictions, businesses transitioning to online (less commuters), etc.
